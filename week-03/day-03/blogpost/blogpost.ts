...
const waitButWhy: BlogPost = new BlogPost('Tim Urban', 'Wait but why', waitText, '2010.10.10');
console.log(waitButWhy);
const oneEngineer: BlogPost = new BlogPost('William Turton', 'One Engineer Is Trying to Get IBM to Reckon With Trump', oneEngineerText, '2017.03.28');
